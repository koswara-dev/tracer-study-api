...
import com.juaracoding.tracerstudy.repository.AlbumRepository;
...
import static com.juaracoding.tracerstudy.utils.AppConstants.ID;
...
public class AlbumServiceImpl implements AlbumService {
	...
	public ResponseEntity<AlbumResponse> updateAlbum(Long id, AlbumRequest newAlbum, UserPrincipal currentUser) {
		...
		throw new TracerStudyException(HttpStatus.UNAUTHORIZED, YOU_DON_T_HAVE_PERMISSION_TO_MAKE_THIS_OPERATION);
	}
